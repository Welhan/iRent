    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Profile Company</h1>
            ...
            <form action="profile/updateProfile" class="formSubmit" autocomplete="off" enctype="multipart/form-data">
                ...
                <input type="hidden" name="oldPic" value="<?= $client->logo; ?>">
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name" name="name" value="<?= $client->nama; ?>">
