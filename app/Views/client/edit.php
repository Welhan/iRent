...
<h1 class="mt-4 mb-4">Edit Client</h1>
    ...
    <div class="col-lg-11">
        <div class="card">
            <div class="card-header bg-primary-subtle">
                ...
                <h5>Edit Client <b><?= ucwords($client->nama); ?></b></h5>
            </div>
            <div class="card-body">
                <form action="client/editClient" class="formSubmit" autocomplete="off">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" class="form-control" id="kota" name="kota" value="<?= $client->kota; ?>" readonly>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="provinsi" name="provinsi" value="<?= $client->provinsi; ?>" readonly>
